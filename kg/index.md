	...
	<div class="container">
		<div class="section-content">
			<div class="section-title">
				<span>Puzly.Co</span> — жаңычыл жана оюнчуга багытталган оюн иштеп чыгуучу студия.
			</div>
			<div class="section-text">
				<span>Puzly.Co</span> — мобилдик платформалар үчүн көңүл ачуучу оюндарды иштеп чыгууга адистешкен оюн студиясы. <span>Puzly.Co</span>, оюн сүйүүчүлөрүнө <span>"Beş Harfli Kelime Oyunu"</span> сыяктуу хит оюндарды сунуштоо үчүн бир катар белгилүү басып чыгаруучулар менен өнөктөш болуп иштейт.
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="section-content">
			...
			<div class="section-footer">
				<a href="{% link games/new-bes-harfli-kelime-oyunu.md %}">Оюндун Деталдары</a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="/games/">Бардык Оюндар</a>
			</div>
		</div>
	</div>
</section>
