	...
	<div class="container">
		<div class="section-content">
			<div class="section-title">
				<span>Dört Harfli Kelime Oyunu</span> түркчө сөз табуучу оюн.
			</div>
			<div class="section-text">
				<span>Dört Harfli Kelime Oyunu</span> бардык курактагы табышмакты сүйгөндөр үчүн түзүлгөн татаал, бирок кызыктуу сөз табуучу оюн. Эгер түрк тилин жетиштүү деңгээлде билем деп ойлосоңуз, анда төмөндөгү шилтеме аркылуу <span>Dört Harfli Kelime Oyunu</span>'н жүктөп орнотуудан тартынбаңыз.
			</div>
			<div class="section-badge">
				<a href="https://play.google.com/store/apps/details?id=co.puzly.dhko" target="_blank"><img alt="Google Playден жүктөп алыңыз" id="gp-logo-img" width="188" height="56" src="/images/google-play-badge-kg.png" /></a>
