	...
	<div class="container">
		<div class="section-content">
			<div class="section-title">
				<span>Five-Letter Word Puzzle</span> англисче сөз табуучу оюн.
			</div>
			<div class="section-text">
				<span>Five-Letter Word Puzzle</span> бардык курактагы табышмакты сүйгөндөр үчүн түзүлгөн татаал, бирок кызыктуу сөз табуучу оюн. Эгер англис тилин жетиштүү деңгээлде билем деп ойлосоңуз, анда төмөндөгү шилтеме аркылуу <span>Five-Letter Word Puzzle</span>'ды жүктөп орнотуудан тартынбаңыз.
			</div>
			<div class="section-badge">
				<a href="https://play.google.com/store/apps/details?id=co.puzly.flwp" target="_blank"><img alt="Google Playден жүктөп алыңыз" id="gp-logo-img" width="188" height="56" src="/images/google-play-badge-kg.png" /></a>
