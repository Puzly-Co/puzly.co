---
title: Four-Letter Turkish Word Finder - Puzly.Co
layout: default
body_class: page-home
show_language_options: true
---

{% include dictionary-loader.html dictionaryFilePath='/data/tr/tr_4_dictionary.json' %}
{% include form-row-template.html numLetters=4 correctPlaceText='correct place' wrongPlaceText='wrong place' absentText='absent' %}
{% include helper-script.html numLetters=4 %}

<section class="helper-content">
	<div class="form-container">
		<span class="title">FOUR-LETTER TURKISH WORD FINDER</span>
